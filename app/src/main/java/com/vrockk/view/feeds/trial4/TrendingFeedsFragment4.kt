...
class TrendingFeedsFragment4 : BaseFragment(), ItemClickListernerWithType,
    SwipeRefreshLayout.OnRefreshListener {
    companion object {
        const val TAG = "TrendingFeedsFragment"
        const val PLAYER_TAG = "trending_feeds_4"
    ...
    var trendingFeedsAdapter: TrendingFeedsAdapter4? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        myMediaPlayer = MyMediaPlayer.createInstance(PLAYER_TAG, context!!)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        trendingFeedsAdapter = TrendingFeedsAdapter4(context!!, feedsData, this, this)
...
//                    myMediaPlayer?.resumeCurrentPlayer()
    ...
    private fun onFeedsChanged() {
        try {
            ...
            myMediaPlayer?.changeItem(currentFeedViewPosition)
    ...
    private fun handleFeedsApiResponse(feedsResponse: HomeResponse) {
        ...
        if (feedsResponse.success) {
            ...
            if (feedsResponse.data.size > 0) {
                ...
                myMediaPlayer?.appendToUrls(videoUrls)
