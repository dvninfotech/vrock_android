...
class FeedsFragment : BaseFragment(), ItemClickListernerWithType,
    ...
    var myPlaylistPlayer: MyPlaylistPlayer? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        myPlaylistPlayer = MyPlaylistPlayer.createInstance(PLAYER_TAG, context!!)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        feedsAdapter = FeedsAdapter(context!!, feedsData, this, this)
    ...
    private fun onPlayingFeedScrolled() {
        try {
            ...
            myPlaylistPlayer?.changeItem(currentFeedViewPosition)
    ...
    private fun handleFeedsApiResponse(feedsResponse: HomeResponse) {
        ...
        if (feedsResponse.success) {
            ...
            if (feedsResponse.data.size > 0) {
                ...
                myPlaylistPlayer?.appendToUrls(videoUrls)
