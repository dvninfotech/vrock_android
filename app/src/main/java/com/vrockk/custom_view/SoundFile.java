...
import com.vrockk.custom_view.song_cutter.MP4Header;
import com.vrockk.custom_view.song_cutter.WAVHeader;
...
public class SoundFile {
    ...
    private void ReadFile(File inputFile)
        ...
        playDuration = (int) format.getLong(MediaFormat.KEY_DURATION);
