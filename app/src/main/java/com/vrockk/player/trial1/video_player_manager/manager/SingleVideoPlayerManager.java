...
import com.vrockk.player.trial1.video_player_manager.Config;
import com.vrockk.player.trial1.video_player_manager.meta.MetaData;
import com.vrockk.player.trial1.video_player_manager.player_messages.ClearPlayerInstance;
import com.vrockk.player.trial1.video_player_manager.player_messages.CreateNewPlayerInstance;
import com.vrockk.player.trial1.video_player_manager.player_messages.SetAssetsDataSourceMessage;
import com.vrockk.player.trial1.video_player_manager.MessagesHandlerThread;
import com.vrockk.player.trial1.video_player_manager.PlayerMessageState;
import com.vrockk.player.trial1.video_player_manager.player_messages.Prepare;
import com.vrockk.player.trial1.video_player_manager.player_messages.Release;
import com.vrockk.player.trial1.video_player_manager.player_messages.Reset;
import com.vrockk.player.trial1.video_player_manager.SetNewViewForPlayback;
import com.vrockk.player.trial1.video_player_manager.player_messages.SetUrlDataSourceMessage;
import com.vrockk.player.trial1.video_player_manager.player_messages.Start;
import com.vrockk.player.trial1.video_player_manager.player_messages.Stop;
import com.vrockk.player.trial1.video_player_manager.ui.MediaPlayerWrapper;
import com.vrockk.player.trial1.video_player_manager.ui.VideoPlayerView;
import com.vrockk.player.trial1.video_player_manager.utils.Logger;

import java.util.Arrays;

/**
 * This implementation of {@link com.vrockk.player.trial1.video_player_manager.manager.VideoPlayerManager} is designed to manage a single video playback.
...
public class SingleVideoPlayerManager implements VideoPlayerManager<MetaData>, VideoPlayerManagerCallback, MediaPlayerWrapper.MainThreadMediaPlayerListener {
     ...
     * then it calls {@link com.vrockk.player.trial1.video_player_manager.manager.PlayerItemChangeListener#onPlayerItemChanged(MetaData)}}
     * To notify that player was switched.
     */
    private final com.vrockk.player.trial1.video_player_manager.manager.PlayerItemChangeListener mPlayerItemChangeListener;

    private VideoPlayerView mCurrentPlayer = null;
    private PlayerMessageState mCurrentPlayerState = PlayerMessageState.IDLE;

    public SingleVideoPlayerManager(com.vrockk.player.trial1.video_player_manager.manager.PlayerItemChangeListener playerItemChangeListener) {
    ...
    /**
     * This method is called by {@link com.vrockk.player.trial1.video_player_manager.player_messages.PlayerMessage}
