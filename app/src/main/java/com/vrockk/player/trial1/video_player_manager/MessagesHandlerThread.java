...
import com.vrockk.player.trial1.video_player_manager.player_messages.Message;
...
public class MessagesHandlerThread {
    ...
    private final com.vrockk.player.trial1.video_player_manager.PlayerQueueLock mQueueLock = new PlayerQueueLock();
